...
NVRAM_DATA(BASE_QWERTY, KANA_ROMAJI, OS_PC, DELAY_DEFAULT,
           MOD_DEFAULT, LED_DEFAULT, IME_MS, PAD_SENSE_1,
           PREFIXSHIFT_OFF);
...
static const uint8_t about_copyright[] = {
    KEY_C, KEY_O, KEY_P, KEY_Y, KEY_R, KEY_I, KEY_G, KEY_H, KEY_T, KEY_SPACEBAR, KEY_2, KEY_0, KEY_1, KEY_3, KEY_MINUS, KEY_2, KEY_0, KEY_2, KEY_3, KEY_SPACEBAR,
