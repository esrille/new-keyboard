 ...
 *
 * This file is a modified version of Keyboard.c provided by
...
void Keyboard(void)
{
    ...
    if (!HIDTxHandleBusy(lastINTransmission))
    {
        ...
        xmit = makeReport(hid_report_in);
        switch (xmit) {
        case XMIT_BRK:
            memset(hid_report_in + 2, 0, 6);
