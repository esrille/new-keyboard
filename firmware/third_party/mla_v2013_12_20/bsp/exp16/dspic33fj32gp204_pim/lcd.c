...
#define LCD_SendData(data) { 	LATDbits.LATD5=0 ; LATBbits.LATB15 =1; LATE &=0xFF00; LATE |= data; LATDbits.LATD4 = 1;Nop();Nop();Nop(); LATDbits.LATD4= 0;LATBbits.LATB15 =0;LCD_Wait(LCD_F_INSTR); }
#define LCD_SendCommand(command, delay) {  LATE &=0xFF00; LATE |=command;LATDbits.LATD5=0 ; LATBbits.LATB15 =0;LATDbits.LATD4 = 1;Nop();Nop();Nop(); LATDbits.LATD4= 0; LCD_Wait(delay); }
...
bool LCD_Initialize(void)
{
   ...
   TRISE &= 0xFF00;
    ...
    LATDbits.LATD5 = 0; // LCD R/W signal
    LATBbits.LATB15 = 0; // LCD RS signal
    LATDbits.LATD4  = 0;     // LCD E signal
